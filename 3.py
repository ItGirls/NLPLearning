#Eliza chat robot
#the role of regular expression or RegEx
...
class Chat(object):
    def __init__(self,pairs,reflections={}):
        ...
        Material which is matched by parenthesized sections of the patterns (e.g. .*) is
        mapped to the numbered positions in the responses,e.g. %1.
        :type pairs:list of tuple
        :param pairs:the patterns responses
    ...
    def _wildcards(self,response,match):
        ...
        while pos>=0:
            ...
            response=response[:pos]+self._substitute(match.group(num))+\
                      response[pos+2:]
            pos=string.find(response,'%')
        return response
